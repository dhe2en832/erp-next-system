/**
 * Unit Tests: Purchase Invoice API Validation
 * Task 4.4: Write unit tests untuk Purchase Invoice API validation
 * 
...
async function runUnitTests() {
  ...
  console.log('🧪 Unit Tests: Purchase Invoice API Validation');
  console.log('   Task 4.4: API validation tests');
  console.log('   Validates: Requirements 3.7, 5.1, 5.2, 5.3');
  console.log('='.repeat(60));
