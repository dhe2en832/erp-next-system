          ...
          <div className="bg-white shadow rounded-lg p-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4">
                <button type="button" onClick={() => router.push('/stock-entry/seList')} className="bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400">Batal</button>
                <button type="button" onClick={handleCreateEntry} className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">Buat Entri Stok</button>
              </div>
            </div>
          </div>
        </div>
