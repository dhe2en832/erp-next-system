...
const COLUMNS: ReportColumn[] = [
  ...
  { key: 'customer_name', label: 'Pelanggan', format: (v, r) => v || r.customer || '-' },
...
function ARPrint() {
  ...
  if (loading) return <LoadingSpinner message="Memuat data piutang..." />;
  ...
  return (
    <A4ReportLayout
      reportTitle="DAFTAR PIUTANG PELANGGAN"
      companyName={company}
      ...
      footerTotals={[
        { label: 'Total Piutang', value: fmtIDR(totalInvoice) },
