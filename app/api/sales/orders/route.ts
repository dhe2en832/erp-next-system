...
export async function GET(request: NextRequest) {
  try {
    ...
    // Build ERPNext URL
    let erpNextUrl = `${ERPNEXT_API_URL}/api/resource/Sales Order?fields=["name","customer","customer_name","transaction_date","grand_total","status","docstatus","delivery_date","custom_notes_so","creation"]&limit_page_length=${limit}&limit_start=${start}`;
