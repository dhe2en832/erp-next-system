...
export async function POST(request: Request) {
  try {
    ...
    const { from_date, to_date, company, mode } = body || {};
    ...
    const data = await fetchProfitReport({ from_date, to_date, company: effectiveCompany, mode: mode || 'valuation' });
    console.log('Profit report raw', { from_date, to_date, company: effectiveCompany }, data);
