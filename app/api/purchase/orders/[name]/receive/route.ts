...
export async function POST(
  ...
  try {
    ...
    console.log('Using REST API PUT method to receive PO:', name);
    ...
    console.log('Receive PO ERPNext Response Status:', response.status);
    console.log('Receive PO ERPNext Response Text:', responseText);
    ...
    if (response.ok) {
      ...
      console.log('PO received successfully:', orderData);
      ...
      let errorMessage = 'Failed to receive Purchase Order';
      ...
      if (data.exc) {
        try {
          ...
          errorMessage = data.message || data.exc || 'Failed to receive Purchase Order';
        }
      ...
      console.error('Receive PO Error Details:', {
        status: response.status,
        data: data,
