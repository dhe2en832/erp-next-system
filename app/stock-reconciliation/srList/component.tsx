      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Rekonsiliasi Stok</h1>
              <p className="mt-1 text-sm text-gray-600">Sesuaikan dan rekonsiliasi kuantitas stok</p>
            </div>
            <button onClick={() => router.push('/stock-reconciliation/srMain')} className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 flex items-center">
